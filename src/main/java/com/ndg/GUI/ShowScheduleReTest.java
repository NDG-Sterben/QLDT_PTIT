...
import com.ndg.Controllers.ScheduleReTestController;
...
public class ShowScheduleReTest extends ParentPanel {
    ...
    public ShowScheduleReTest(@NotNull JPanel panel, int idLogin) {
        ...
        new ScheduleReTestController(this);
    }
